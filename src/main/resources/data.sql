...
insert into upp_nc.user (dtype, id, city, email, name, password, state, surname, token, username, magazine_id) values ('User', 994, 'Ns', 'pera@gmail.com', 'Pera', '$2a$10$3U98gKM8r7PneVfLMx3gAusqXXvxcz68nywc2fe4t9XDuJoLe5O1W', 'Active', 'P', NULL, 'pera', NULL);
