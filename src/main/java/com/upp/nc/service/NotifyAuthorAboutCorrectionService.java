...
public class NotifyAuthorAboutCorrectionService implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		String subject = "Your work needs correction";
		String message = "Your scientific work has been reviewed and it needs some corrections to be accepted to magazine.";
