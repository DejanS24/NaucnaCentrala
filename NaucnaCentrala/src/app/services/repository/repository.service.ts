...
export class RepositoryService {
  ...
  getTasks(processInstance : string){
    ...
    return this.httpClient.get('http://localhost:8070/user/register/'.concat(processInstance)) as Observable<any>
  }
  ...
  completeTask(taskId){
    return this.httpClient.post('http://localhost:8070/welcome/tasks/complete/'.concat(taskId), null) as Observable<any>
  }
